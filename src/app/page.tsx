...
import BrandPhone from '../app/assets/Brand-Phone.svg';
import BrandSet from '../app/assets/Brand-Set.svg';
import DotPattern from '../app/assets/Dot Pattern.svg';
import IngredientsRecipe from '../app/assets/Ingredients and recipe.svg';
import BrandBox from '../app/assets/Brand Box.svg';
import BrandLedger from '../app/assets/Brand-Ledger.svg';
      ...
      <div className="flex flex-col gap-12 px-4">
        ...
        <section className="flex flex-col gap-10">
          <div className="flex flex-col gap-3">
            <h2 className="text-[#111827] text-2xl leading-8 font-extrabold tracking-tight">Personalised & Dynamic Recipes</h2>
          ...
          <div className="relative h-[500px] w-full">
            ...
            <Image src={IngredientsRecipe} alt="Ingredient-Recipe" className="absolute left-11" />
          </div>
        </section>
        <section className="flex flex-col gap-10">
          <div className="flex flex-col gap-3">
            <h2 className="text-[#111827] text-2xl leading-8 font-extrabold tracking-tight">One-of-a-kind Shopping Experience</h2>
